...
ActiveRecord::Schema[8.1].define(version: 2026_05_12_021500) do
  ...
  create_table "brands", force: :cascade do |t|
    ...
    t.string "logo_background_color", default: "#FFFFFF", null: false, comment: "E-postada logo container BG rengi (hex)"
