...
// DOCSIGN-CUSTOM: Türkçe çeviriler
const tr = {
  step: 'Adım',
  form_progress: 'Form ilerlemesi',
  close: 'Kapat',
  uploaded_files: 'Yüklenen dosyalar',
  signature_drawing_area: 'İmza çizim alanı. İmzanızı çizmek için fareyi veya dokunmayı kullanın.',
  kba: 'Bilgi Tabanlı Doğrulama',
  please_upload_an_image_file: 'Lütfen bir resim dosyası yükleyin',
  must_be_characters_length: '{number} karakter uzunluğunda olmalı',
  complete_all_required_fields_to_proceed_with_identity_verification: 'Kimlik doğrulamaya devam etmek için tüm gerekli alanları doldurun.',
  verify_id: 'Kimlik Doğrula',
  identity_verification: 'Kimlik doğrulama',
  complete: 'Tamamla',
  fill_all_required_fields_to_complete: 'Tamamlamak için tüm gerekli alanları doldurun',
  sign_and_complete: 'İmzala ve Tamamla',
  text: 'Metin',
  by_clicking_you_agree_to_the: '"{button}" butonuna tıklayarak şunları kabul etmiş olursunuz:',
  electronic_signature_disclosure: 'Elektronik İmza Bildirgesi',
  esignature_disclosure: 'e-İmza Bildirgesi',
  signature: 'İmza',
  initials: 'Paraf',
  sign_on_the_touchscreen: 'Dokunmatik ekrandan imzalayın',
  approved: 'Onaylandı',
  reviewed: 'İncelendi',
  other: 'Diğer',
  authored_by_me: 'Tarafımdan oluşturuldu',
  invite: 'Davet et',
  email: 'E-posta',
  approved_by: 'Onaylayan',
  reviewed_by: 'İnceleyen',
  authored_by: 'Oluşturan',
  select_a_reason: 'Bir neden seçin',
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: 'Formu mobilde açıp imzanızı çizmek için kamera uygulamasıyla QR kodu tarayın',
  date: 'Tarih',
  number: 'Sayı',
  value_is_invalid: 'Değer geçersiz',
  verification_code_is_invalid: 'Doğrulama kodu geçersiz',
  already_paid: 'Zaten ödendi',
  image: 'Resim',
  pay: 'Öde',
  take_photo: 'Fotoğraf çek',
  number_phone_is_invalid: '{number} telefon geçersiz',
  file: 'Dosya',
  digitally_signed_by: 'Dijital imzalayan',
  reason: 'Neden',
  select: 'Seç',
  ...
  type_here_: 'Buraya yazın...',
  optional: 'opsiyonel',
  option: 'Seçenek',
  appears_on: 'Şurada görünür',
  page: 'Sayfa',
  select_your_option: 'Bir seçenek belirleyin',
  complete_hightlighted_checkboxes_and_click: 'Vurgulanmış onay kutularını işaretleyip tıklayın',
  submit: 'gönder',
  next: 'sonraki',
  click_to_upload: 'Yüklemek için tıklayın',
  or_drag_and_drop_files: 'veya dosyaları sürükleyip bırakın',
  send_copy_via_email: 'E-posta ile kopya gönder',
  download: 'İndir',
  clear: 'Temizle',
  redraw: 'Yeniden çiz',
  draw_initials: 'Paraf çiz',
  type_signature_here: 'İmzayı buraya yazın',
  type_initial_here: 'Parafı buraya yazın',
  form_has_been_completed: 'Belgeniz başarıyla imzalanmıştır',
  document_has_been_signed: 'Belgeniz başarıyla imzalanmıştır',
  documents_have_been_signed: 'Belgeleriniz başarıyla imzalanmıştır',
  create_a_free_account: 'Ücretsiz Hesap Oluştur',
  powered_by: '',
  please_check_the_box_to_continue: 'Devam etmek için kutuyu işaretleyin.',
  open_source_documents_software: '',
  verified_phone_number: 'Telefon Numarasını Doğrula',
  use_international_format: 'Uluslararası format kullanın: +1xxx',
  six_digits_code: '6 haneli kod',
  change_phone_number: 'Telefon numarasını değiştir',
  sending: 'Gönderiliyor...',
  resend_code: 'Kodu yeniden gönder',
  verification_code_has_been_resent: 'Doğrulama kodu SMS ile yeniden gönderildi',
  please_fill_all_required_fields: 'Lütfen tüm gerekli alanları doldurun',
  set_today: 'Bugünü Ayarla',
  toggle_multiline_text: 'Çok satırlı metni aç/kapa',
  draw_signature: 'İmza çiz',
  type_initial: 'Parafı yaz',
  draw: 'Çiz',
  type: 'Yaz',
  type_text: 'Metin yaz',
  email_has_been_sent: 'E-posta gönderildi',
  processing: 'İşleniyor',
  pay_with_stripe: 'Stripe ile öde',
  reupload: 'Yeniden yükle',
  upload: 'Yükle',
  files: 'Dosyalar',
  signature_is_too_small_or_simple_please_redraw: 'İmza çok küçük veya basit. Lütfen yeniden çizin.',
  browser_privacy_settings_block_canvas: 'Tarayıcınızın gizlilik ayarları çizim canvas\'ını kısıtlıyor. Lütfen başka bir tarayıcı veya cihaz kullanın ya da imza atabilmek için canvas\'ı engelleyen gizlilik ayarlarını devre dışı bırakın.',
  wait_countdown_seconds: '{countdown} saniye bekleyin',
  enter_screen_reader_mode: 'Ekran okuyucu modunu aç'
}

const i18n = { en, es, it, de, fr, pl, uk, cs, pt, he, nl, ar, ko, ja, tr }
